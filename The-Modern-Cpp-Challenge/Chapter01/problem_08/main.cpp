// change log
// 2022-06-01 K.OHWADA
// add "print_narcissistics_1 true"
...
int main()
{
std::cout << "print_narcissistics_1 true" << std::endl;
   print_narcissistics_1(true);
std::cout << "print_narcissistics_2 true" << std::endl;
   print_narcissistics_2(true);
std::cout << "print_narcissistics_3 true" << std::endl;
   print_narcissistics_3(1000, true);

std::cout << "print_narcissistics_1 false" << std::endl;
...
std::cout << "print_narcissistics_2 false" << std::endl;
...
std::cout << "print_narcissistics_3 false" << std::endl;
